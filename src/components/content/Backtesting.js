...
const Backtesting = () => {
    return (<div className='card'>
                <div className='card-body justify-content-left'>
                        ...
                        <div className="card mt-3">
                        <h5 className="mt-3">Parameter Definitions:</h5>
                        <p>The following are the parameters used to run a backtest and a trade strategy. <strong>Read carefully!</strong></p>
                        <ul className="list-unstyled">
                            ...
                            <li><strong>whitelist_symbols:</strong> Are there any cryptocurrencies you're interested in trading? If not, keep this as ALL.
                            </li>
                        </ul>
                        </div>
                        <div className="card mt-3">
